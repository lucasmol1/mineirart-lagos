...
function renderTopbar(){
  ...
  tb.innerHTML=`<button id="hamburger-btn" aria-label="Menu">☰</button>
    ...
    <div style="position:relative">
      <div class="topbar-user" id="user-btn"><div class="user-avatar">${initials(currentProfile.name)}</div><span class="topbar-user-name">${esc(currentProfile.name)}</span><span style="font-size:10px;color:#c8f04e;margin-left:5px;font-weight:700">v1</span><span style="font-size:11px;color:#7a7a8a;margin-left:2px">▾</span></div>
...
const BONUS_TYPES = [
  ...
  {id:'disponibilidade', label:'Disponibilidade',        valor:+2, cap:+4,
   desc:'+2pts por disponibilidade e cobertura de colega. Máx +4pts/mês.'},
