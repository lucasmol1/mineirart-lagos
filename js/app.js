...
function renderTopbar(){
  ...
  tb.innerHTML=`<button id="hamburger-btn" aria-label="Menu">☰</button>
    ...
    <div style="position:relative">
      <div class="topbar-user" id="user-btn"><div class="user-avatar">${initials(currentProfile.name)}</div><span class="topbar-user-name">${esc(currentProfile.name)}</span><span style="font-size:10px;color:#c8f04e;margin-left:5px;font-weight:700">v1.1</span><span style="font-size:11px;color:#7a7a8a;margin-left:2px">▾</span></div>
...
function perfInit(){
  ...
  perfSESSION=u;
  const _un=document.getElementById('sidebar-uname');
  const _ur=document.getElementById('sidebar-urole');
  if(_un)_un.textContent=nome;
  if(_ur)_ur.textContent='Admin';
}
...
<aside class="sidebar">
  ...
  <div class="nav-item active" onclick="perfShowPage('dashboard')"><span class="nav-icon">⬡</span><span>Dashboard</span></div>
  <div class="nav-item" onclick="perfShowPage('tabela')"><span class="nav-icon">▦</span><span>Tabela Geral</span></div>
  ...
  <div class="nav-item" onclick="perfShowPage('historico')"><span class="nav-icon">◷</span><span>Histórico de Ações</span></div>
  <div class="nav-section">Config</div>
  <div class="nav-item" onclick="perfShowPage('funcionarios')"><span class="nav-icon">◈</span><span>Funcionários</span></div>
  <div class="nav-item" onclick="perfShowPage('regras')"><span class="nav-icon">⚖</span><span>Regras de Score</span></div>
  <div class="nav-item" onclick="perfShowPage('exportar')"><span class="nav-icon">↗</span><span>Exportar</span></div>
...
<main class="main">
  <div class="topbar">
    ...
    <div class="topbar-actions">
      <div class="month-selector">📅<select id="month-global" onchange="perfRenderAll()"></select></div>
  ...
  <div class="content">
    ...
    <div class="page" id="page-funcionario">
      <div style="margin-bottom:16px;"><button class="btn-ghost btn-sm" id="back-btn" onclick="perfShowPage('tabela')">← Voltar</button></div>
