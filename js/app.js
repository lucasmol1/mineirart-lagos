...
function perfInit(){
  ...
  if(ur)ur.textContent={admin:"Admin",manager:"Gestor",viewer:"Visualizador"}[u.role]||u.role;
}
...
// ============================================================
// LOGIN (perf — não conflita com doLogin do sistema principal)
// ============================================================
...
function perfDoLogout(){
  // Perf não tem logout próprio — usa o do sistema principal
  perfSESSION=null;
}
