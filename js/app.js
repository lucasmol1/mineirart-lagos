...
function renderAdminPage(){
  ...
  return`<div class="page-header"><div><div class="page-title">Administração</div></div>${backupBtn}</div>
    ...
    <div class="admin-section">
      ...
      <div style="margin-top:8px;font-size:12px;color:#5a5a6a">✅ O sistema nunca excede esses limites automaticamente — ele bloqueia novos itens quando o limite é atingido.</div>
    </div>
