...
// LOGIN
// ============================================================
function perfDoLogin(){
  // Perf usa Firebase Auth do sistema principal — sem login separado
}
function perfDoLogout(){
  // Perf não tem logout próprio
  perfSESSION=null;
}
...
<aside class="sidebar">
  ...
  <div style="padding:8px 12px 12px"><button onclick="nav('dashboard');render()" style="width:100%;padding:8px;background:rgba(91,110,245,0.12);border:1px solid rgba(91,110,245,0.25);border-radius:8px;color:#5b6ef5;font-size:12px;cursor:pointer;font-family:inherit">← Voltar ao Sistema</button></div>
...
<div class="overlay" id="overlay-bonus">
  <div class="modal">
    ...
    <div class="form-group"><label class="form-label">Motivo / Descrição</label><textarea class="form-control" id="bon-motivo" rows="2" placeholder="Ex: Semana completa sem falhas, disponibilidade extra..."></textarea></div>
    <div class="modal-actions">
