...
function salvarFuncionario(){
  ...
  perfSaveDB();closeModal('overlay-func');renderAll();
}
...
function salvarFalha(){
  ...
  perfSaveDB();closeModal('overlay-falha');perfNotify('Falha registrada');renderAll();
}
...
function salvarBonus(){
  ...
  perfSaveDB();closeModal('overlay-bonus');perfNotify('Bônus registrado!','green');renderAll();
}
...
function salvarUser(){
  ...
  perfSaveDB();closeModal('overlay-user');
  /* sidebar handled by main app */
  renderAll();
}
...
function salvarSenha(){
  ...
  perfSaveDB();closeModal('overlay-pwd');perfNotify('Senha alterada');
}
